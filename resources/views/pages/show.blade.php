                ...
                <div class="col-md-8">
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle" src="{{ asset('front/images/comment-img.jpg') }}" alt="">
                        </div>
                    ...
                    <div class="primary-sidebar">
                            ...
                            <div class="thumb-latest-posts">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#" class="popular-img"><img src="{{ asset('front/images/r-p.jpg') }}"
                                                                             alt="">
                        ...
                        <aside class="widget pos-padding">
                            ...
                            <div class="instragram-follow">
                                <a href="#">
                                    <img src="{{ asset('front/images/ins-flow.jpg') }}" alt="">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('front/images/ins-flow.jpg') }}" alt="">
                                </a>
